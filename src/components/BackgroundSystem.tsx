...
export default function BackgroundSystem() {
  ...
  return (
    <div className="fixed inset-0 -z-50 h-full w-full overflow-hidden bg-[#030303] pointer-events-none">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_18%,rgba(255,255,255,0.07)_0%,rgba(255,255,255,0.03)_18%,transparent_48%)]" />
      <motion.div
        style={{ opacity: ambientGlow }}
        className="absolute inset-0 bg-[radial-gradient(circle_at_78%_20%,rgba(255,255,255,0.08)_0%,transparent_34%)]"
      />
      
      {/* UPDATED: Reduced the black overlay opacity (from 44 to 20) 
        and reduced blur (from 2px to 1px) to make images clearer 
      */}
      <div className="absolute inset-0 bg-black/6 backdrop-blur-[0.5px]" />
