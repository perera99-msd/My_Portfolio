...
export default function Projects() {
  ...
  return (
    <section className="relative z-10 mx-auto w-full max-w-[1600px] px-3 py-18 sm:px-4 lg:px-12 lg:py-32">
      <Reveal>
      ...
      <Reveal delay={0.2}>
        <div
          ...
          className="group relative flex h-auto min-h-0 w-full flex-col overflow-visible rounded-[2rem] border border-white/[0.08] shadow-[0_44px_110px_-25px_rgba(0,0,0,0.9)] lg:h-[84vh] lg:min-h-[700px] lg:max-h-[940px] lg:rounded-[2.65rem]"
        >
          <div className="absolute inset-0 z-0 overflow-hidden rounded-[2rem] bg-[#050505] lg:rounded-[2.65rem]">
            <AnimatePresence mode="wait">
              ...
              >
                <Image
                  src={getBackgroundImage(projects[activeIndex])}
          ...
          <div className="relative z-40 flex h-full flex-col px-4 pb-5 pt-4 sm:px-8 sm:pb-8 sm:pt-5 lg:px-14 lg:pb-14 lg:pt-10">
            <div className="mt-1 grid flex-1 gap-6 lg:mt-4 lg:grid-cols-[1.18fr_0.82fr] lg:items-end lg:gap-8">
              <div className="flex flex-col justify-end">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <h3
                      className="font-serif uppercase leading-[0.95] tracking-[0.02em] text-white drop-shadow-[0_10px_30px_rgba(0,0,0,0.55)]"
                      style={{ fontSize: 'clamp(1.95rem, 10vw, 5.9rem)' }}
                    >
                      {projects[activeIndex].title}
                    </h3>

                    <p className="mt-4 max-w-[55ch] text-[0.78rem] leading-[1.78] tracking-[0.06em] text-white/74 sm:mt-6 sm:text-[0.86rem] lg:text-[0.92rem]">
                    ...
                    <div className="mt-8 flex flex-wrap gap-2.5">
                      {projects[activeIndex].stack.map((tech) => (
                        <span
                          key={tech}
                          className="rounded-full border border-white/16 bg-white/[0.05] px-3 py-1.5 text-[0.56rem] font-bold uppercase tracking-[0.2em] text-white/78 backdrop-blur-md"
                        >
                          {tech}
                        </span>
                      ))}
                    ...
                    <div className="mt-7 flex flex-wrap items-center gap-3 sm:mt-9 sm:gap-4">
                      <Link
                        ...
                        target="_blank"
                        className="group/btn inline-flex w-full items-center justify-center gap-3 rounded-full border border-white/22 bg-white/[0.08] px-4 py-3 text-[0.6rem] font-bold uppercase tracking-[0.18em] text-white transition-all duration-500 hover:border-white/35 hover:bg-white/16 sm:w-auto sm:text-[0.62rem] sm:tracking-[0.22em]"
                      >
                      ...
                      <Link
                        ...
                        target="_blank"
                        className="group/git inline-flex w-full items-center justify-center gap-3 rounded-full border border-white/22 bg-white/[0.08] px-4 py-3 text-[0.6rem] font-bold uppercase tracking-[0.18em] text-white transition-all duration-500 hover:border-white/35 hover:bg-white/16 sm:w-auto sm:text-[0.62rem] sm:tracking-[0.22em]"
                      >
                      ...
                      <span className="text-[0.58rem] font-semibold uppercase tracking-[0.18em] text-white/55 sm:text-[0.6rem] sm:tracking-[0.22em]">
                        No. 0{activeIndex + 1}
                      </span>
                    </div>
                  </motion.div>
                  ...
                  {projects.map((project, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group/card relative h-[220px] w-[132px] shrink-0 overflow-hidden rounded-[1.1rem] border text-left transition-all duration-700 ease-[0.22,1,0.36,1] sm:h-[258px] sm:w-[148px] lg:h-[290px] lg:w-[168px] ${
                          isActive
                      ...
                      >
                        <Image
                          ...
                          alt={project.title}
                          fill
                          className="object-cover transition-transform duration-[1800ms] group-hover/card:scale-110"
                        />
                        ...
                        {isActive && (
                          <motion.div
                            ...
                            className="absolute left-0 top-0 z-30 h-[2px] bg-white"
                          />
                        )}
            ...
            <div className="mt-5 flex flex-col gap-4 lg:mt-8 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-[25rem] rounded-2xl border border-white/18 bg-white/[0.08] p-4 backdrop-blur-xl">
                ...
                <p className="text-[0.76rem] leading-[1.65] text-white/78">
                  Story-driven interfaces with premium glass layering, cinematic motion, and clear product-focused UX.
                </p>
              </div>

              <div className="flex items-center gap-2.5 self-start sm:self-end lg:self-auto">
                <button
                  type="button"
                  onClick={goPrev}
                  className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-white/[0.08] text-white transition-all duration-500 hover:border-white/34 hover:bg-white/16"
